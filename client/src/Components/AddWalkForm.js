...
return (
        ...
        <h2 class="title"> Do you want to share your walk? </h2>
            ...
            <div className="row">
                ...
                <div class ="form-group col-md-4">
                    <label className="form-label"> What is the latitude?</label>
                    <input 
                        name="walklatitude"
                        type = "text"
                        value={formAllData.walklatitude}
                        onChange={handleChange}
                        class="form-control"
                        required
                    />
                ...
                <div class ="form-group col-md-4">
                    <label className="form-label"> What is the longitude?</label>
                    <input 
                        name="walklongitude"
                        type = "text"
                        value={formAllData.walklongitude}
                        onChange={handleChange}
                        class="form-control"
                        required
                    />
