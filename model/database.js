...
con.connect(function (err) {
  ...
  let sql =
    "DROP TABLE if exists user; CREATE TABLE user(user_Id INT NOT NULL, user_name VARCHAR(255) not null, user_email VARCHAR(255) not null, password VARCHAR(255) not null, location VARCHAR(255) not null, user_dog_name VARCHAR(255) not null, user_dog_description VARCHAR(255) not null, PRIMARY KEY (user_Id));DROP TABLE if exists walks; CREATE TABLE walk (walk_name VARCHAR(255) NOT NULL,location VARCHAR(255) NOT NULL,address VARCHAR(255) NOT NULL,types VARCHAR(255) NOT NULL,length VARCHAR(255) NOT NULL,rating INT NOT NULL,difficulty INT NOT NULL,description VARCHAR(255) NOT NULL);";
